...
cmdline_bd_code = 'livox0000000011'

# cur_path = os.path.split(os.path.realpath(__file__))[0] + '/'
cur_config_path = '/home/talon/ros2_ws/src/Sensor_drivers/ws_livox/src/livox_ros_driver2/config'
rviz_config_path = os.path.join(cur_config_path, 'display_point_cloud_ROS2_rear.rviz')
user_config_path = os.path.join(cur_config_path, 'MID360_rear_config.json')
...
def generate_launch_description():
    ...
    livox_driver = Node(
        ...
        name='livox_lidar_rear_publisher',
        output='screen',
    ...
    livox_rviz = Node(
            package='rviz2',
            executable='rviz2',
            name='livox_rviz_rear',
            output='screen',
            arguments=['--display-config', rviz_config_path]
        )

    # # static_transform_publisher 노드 추가 (TF 등록)
    # roll = radians(rotations[0][0])
    ...
    #             'livox2_frame'   # child frame: 카메라 frame 이름에 맞게!
    #         ],
    #         output='screen'
    #     )
