...
void *AHRS_thread(void *arg)
{
    while (run)
    {
        if (MW_SerialRecv(&id, &length, recv_buffer))
        {
            switch ((int)(unsigned char)recv_buffer[1])
            {
            case ACC:
                acc_x = ((int)(unsigned char)recv_buffer[2] | (int)(unsigned char)recv_buffer[3] << 8);
                acc_y = ((int)(unsigned char)recv_buffer[4] | (int)(unsigned char)recv_buffer[5] << 8);
                acc_z = ((int)(unsigned char)recv_buffer[6] | (int)(unsigned char)recv_buffer[7] << 8);
            ...
            case GYO:
                gyo_x = ((int)(unsigned char)recv_buffer[2] | (int)(unsigned char)recv_buffer[3] << 8);
                gyo_y = ((int)(unsigned char)recv_buffer[4] | (int)(unsigned char)recv_buffer[5] << 8);
                gyo_z = ((int)(unsigned char)recv_buffer[6] | (int)(unsigned char)recv_buffer[7] << 8);
            ...
            case DEG:
		        deg_x = ((int)(unsigned char)recv_buffer[2] | (int)(unsigned char)recv_buffer[3] << 8);
                deg_y = ((int)(unsigned char)recv_buffer[4] | (int)(unsigned char)recv_buffer[5] << 8);
                deg_z = ((int)(unsigned char)recv_buffer[6] | (int)(unsigned char)recv_buffer[7] << 8);
    ...
    {
        if(MW_SerialOpen("/dev/ttyUSB0", 921600) < 0)
        {
            return -1;
        }
